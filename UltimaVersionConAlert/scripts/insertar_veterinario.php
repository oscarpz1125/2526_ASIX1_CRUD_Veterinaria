...
// Comprobamos si ya existe un veterinario con email o telefono iguales
$checkSql = "SELECT id FROM veterinarios WHERE email = ? OR telefono = ? LIMIT 1";
...
if ($checkStmt) {
    ...
    if (mysqli_stmt_num_rows($checkStmt) > 0) {
        $_SESSION['error_veterinario'] = "Ya existe un veterinario con ese email o telefono.";
